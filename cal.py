...
#operator button 13
btnDelete = Button(buttomFrame,text="<",font=btnFont,bg="orange",fg="white",command=delete)
btnPersen = Button(buttomFrame,text="%",font=btnFont,bg=Opcolor,fg="white",command=persen)
btnClear = Button(buttomFrame,text="Clear",font=btnFont,bg="orange",fg="white",command=clearDisplay)
btnQuit = Button(buttomFrame,text="Quit",font=btnFont,bg="orange",fg="white",command=root.destroy)
btnInvert = Button(buttomFrame,text="1/x",font=btnFont,bg=Opcolor,fg="white",command=invert)
btnSquare = Button(buttomFrame,text="x^2",font=btnFont,bg=Opcolor,fg="white",command=square)
...
btnNegate = Button(buttomFrame,text="+/-",font=btnFont,bg=Opcolor,fg="white",command=negate)
